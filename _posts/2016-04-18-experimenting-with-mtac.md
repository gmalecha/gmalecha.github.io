...
entire language including complex dependent types, which systems like [MirrorCore](/publications/2015/rtac-a-fully-reflective-tactic-language/) do not currently support (though it is [in progress](//github.com/gmalecha/mirror-core/tree/poly)).
...
[^fn-chart]: Results for Ltac and Rtac are taken from [Extensible and Efficient Automation through Reflective Tactics, ESOP'16](/publications/2016/extensible-and-efficient-automation-through-reflective-tactics/).
