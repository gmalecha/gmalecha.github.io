...
In this post I'm going to discuss [Rtac](https://github.com/gmalecha/mirror-core) the reflective tactic language that I developed as a central piece of [my dissertation](/publications/2015/extensible-proof-engineering-in-intensional-type-theory/).
...
I will not go into the details of what computational reflection is in this post, [I've discussed it in the past]({{ '/reflections/2015/computational-reflection-primer/' | url }}). At the high level, we're going to replace a large proof term with a computation and prove that the computation implies the existence of a proof of the property.
...
The code is adapted from the [Ynot cancellation algorithm](/publications/2009/effective-interactive-proofs-for-higher-order-imperative-programs/).
...
For example, in my work on [MirrorShard](/publications/2014/compositional-computational-reflection/) I describe how gluing reflective procedures together with reflection is *substantially* more efficient than doing it in Ltac.
...
The main ideas in this post are covered in [my dissertation](/publications/2015/extensible-proof-engineering-in-intensional-type-theory/) and [our ESOP'16 paper](/publications/2016/extensible-and-efficient-automation-through-reflective-tactics/).
